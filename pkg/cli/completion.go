...
func (r *Runner) bashCompletionAction(_ context.Context, _ *cli.Command) error {
...
complete -o bashdefault -o default -o nospace -F _cli_bash_autocomplete aqua-registry`)
	return nil
}

func (r *Runner) zshCompletionAction(_ context.Context, _ *cli.Command) error {
...
compdef _cli_zsh_autocomplete aqua-registry`)
	return nil
}
